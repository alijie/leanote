...
func Test_initMongo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			initMongo(tt.args.url, tt.args.dbname)
		})
	}
}
...
func TestInsert(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Insert(tt.args.collection, tt.args.i); got != tt.want {
...
func TestUpdate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Update(tt.args.collection, tt.args.query, tt.args.i); got != tt.want {
...
func TestUpdateAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateAll(tt.args.collection, tt.args.query, tt.args.i); got != tt.want {
				t.Errorf("UpdateAll() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestUpdateByIdAndUserId(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByIdAndUserId(tt.args.collection, tt.args.id, tt.args.userId, tt.args.i); got != tt.want {
				t.Errorf("UpdateByIdAndUserId() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByIdAndUserId2(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByIdAndUserId2(tt.args.collection, tt.args.id, tt.args.userId, tt.args.i); got != tt.want {
				t.Errorf("UpdateByIdAndUserId2() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByIdAndUserIdField(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByIdAndUserIdField(tt.args.collection, tt.args.id, tt.args.userId, tt.args.field, tt.args.value); got != tt.want {
				t.Errorf("UpdateByIdAndUserIdField() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByIdAndUserIdMap(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByIdAndUserIdMap(tt.args.collection, tt.args.id, tt.args.userId, tt.args.v); got != tt.want {
				t.Errorf("UpdateByIdAndUserIdMap() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByIdAndUserIdField2(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByIdAndUserIdField2(tt.args.collection, tt.args.id, tt.args.userId, tt.args.field, tt.args.value); got != tt.want {
				t.Errorf("UpdateByIdAndUserIdField2() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByIdAndUserIdMap2(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByIdAndUserIdMap2(tt.args.collection, tt.args.id, tt.args.userId, tt.args.v); got != tt.want {
				t.Errorf("UpdateByIdAndUserIdMap2() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByQField(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		q          interface{}
		field      string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByQField(tt.args.collection, tt.args.q, tt.args.field, tt.args.value); got != tt.want {
				t.Errorf("UpdateByQField() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByQI(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		q          interface{}
		v          interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByQI(tt.args.collection, tt.args.q, tt.args.v); got != tt.want {
				t.Errorf("UpdateByQI() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestUpdateByQMap(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		q          interface{}
		v          interface{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateByQMap(tt.args.collection, tt.args.q, tt.args.v); got != tt.want {
				t.Errorf("UpdateByQMap() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestDelete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Delete(tt.args.collection, tt.args.q); got != tt.want {
...
func TestDeleteByIdAndUserId(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := DeleteByIdAndUserId(tt.args.collection, tt.args.id, tt.args.userId); got != tt.want {
				t.Errorf("DeleteByIdAndUserId() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestDeleteByIdAndUserId2(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := DeleteByIdAndUserId2(tt.args.collection, tt.args.id, tt.args.userId); got != tt.want {
				t.Errorf("DeleteByIdAndUserId2() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestDeleteAllByIdAndUserId(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := DeleteAllByIdAndUserId(tt.args.collection, tt.args.id, tt.args.userId); got != tt.want {
				t.Errorf("DeleteAllByIdAndUserId() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestDeleteAllByIdAndUserId2(t *testing.T) {
	type args struct {
		collection *mongo.Collection
		id         string
		userId     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := DeleteAllByIdAndUserId2(tt.args.collection, tt.args.id, tt.args.userId); got != tt.want {
				t.Errorf("DeleteAllByIdAndUserId2() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestDeleteAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := DeleteAll(tt.args.collection, tt.args.q); got != tt.want {
